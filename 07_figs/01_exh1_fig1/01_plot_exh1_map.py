...
# Import paths
# -------------------
HURR_TRACKS_CSV = "/gpfs/data/cms-share/duas/52484/Jessy/data/public_data/data/brooke_hurricane/update_ryanzomorrodi/hurr_tracks.csv"
...
storms_all21 = list(storm_meta.keys())
...
tracks = tracks[tracks["storm_id"].isin(storms_all21)].copy()
...
# -------------------
# 6) Build storm->color mapping FIXED to storms_all21 order
# -------------------
...
colors_all = (tab20 + tab20b)[:len(storms_all21)]
storm_color = dict(zip(storms_all21, colors_all))
...
ordered_for_legend = legend_order_cat_then_time(storms_all21)
