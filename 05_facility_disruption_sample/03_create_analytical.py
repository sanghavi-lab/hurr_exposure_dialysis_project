...
client = Client("10.50.87.48:37479")
print(client)
...
) # This data was created from the hurricane wind-exposed sample pipeline
...
def dialysis_features_from_op_year_anchor(cohort: pd.DataFrame, op_pq: str) -> pd.DataFrame:
    ...
    grp = grp.rename(columns={ # renaming
...
def make_long_panel_exposure_anchor(
    ...
    for col in ["n_dialysis_wk_m2","n_dialysis_wk0","n_dialysis_wk1","n_dialysis_wk2","n_dialysis_wk3"]:
